...
def main(argv): #100, 0.1, 0.1, 0, 0.8, 0.9, 20
    ...
    likers.loc[likers['favorite_tweets'] > 20, 'favorite_tweets'] = 20
    maximum_cap(likers, 'freq_posts', 0.1)
    likers.loc[likers['freq_replies']>0.5, 'freq_replies'] = 0.5
    ...
    draw_community(G, comm_bi, 'results/community_bi_d') #.png
    print(comm_bi_val)
    ...
    draw_community(G, comm_mo, 'results/community_mo_d') #.png
    print(comm_mo_val)
    ...
    if comm_lp_num == 0:
        ...
        draw_community(G, comm_lp, 'results/community_lp_d') #.png
    print(comm_lp_val)
