...
def main(argv): #100, 0.1, 0.1, 0, 0.8, 0.9, 20
    ...
    draw_community(G, comm_bi, 'results/community_c_bi_' + str(int(puh * 100)) ) #+ '.png'
    print(comm_bi_val)
    ...
    draw_community(G, comm_mo, 'results/community_c_mo_' + str(int(puh * 100)) )
    print(comm_mo_val)
    ...
    if comm_lp_num == 0:
        ...
        draw_community(G, comm_lp, 'results/community_c_lp_' + str(int(puh * 100)) )
    print(comm_lp_val)
