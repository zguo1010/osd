...
def main(argv): #100, 0.1, 0.1, 0, 0.8, 0.9, 20
    ...
    draw_community(G, comm_bi, 'results/community_bi_a') #.png
    print(comm_bi_val)
    ...
    draw_community(G, comm_mo, 'results/community_mo_a')
    print(comm_mo_val)
    ...
    if comm_lp_num == 0:
        ...
        draw_community(G, comm_lp, 'results/community_lp_a')
    print(comm_lp_val)
    ...
    if puh == 1.0:
        ...
        plt.savefig('results/degree_k_a.png')
        plt.clf()

    # parallel running
    directory = 'res1ks/tmpa/'
