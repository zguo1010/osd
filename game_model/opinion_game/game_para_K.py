...
def main(argv):
    ...
    draw_community(G, comm_bi, 'results/community_bi_' + str(int(puh * 100)) ) #+ '.png'
    print(comm_bi_val)
    ...
    draw_community(G, comm_mo, 'results/community_mo_' + str(int(puh * 100)) )
    print(comm_mo_val)
    ...
    if comm_lp_num == 0:
        ...
        draw_community(G, comm_lp, 'results/community_lp_' + str(int(puh * 100)) )
    print(comm_lp_val)
    ...
    # parallel running
    directory = 'res1ks/tmp%d/' % int(puh * 100)
    ...
    with open('node_k_'+ str(int(puh*100)) +'.txt', 'w') as f:
        #write parameters
        f.write("%s\n" % list(argv))
        f.write("%s\n" % list(nodes['A']))
        f.write("%s\n" % list(nodes['T']))
    ...
    with open('op_k_'+ str(int(puh*100)) +'.txt', 'w') as f:
