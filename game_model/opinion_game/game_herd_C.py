...
def main(argv): #100, 0.1, 0.1, 0, 0.8, 0.9, 20
    ...
    draw_community(G, comm_bi, 'results/community_c_bi_d') #+ '.png'
    print(comm_bi_val)
    ...
    draw_community(G, comm_mo, 'results/community_c_mo_d')
    print(comm_mo_val)
    ...
    if comm_lp_num == 0:
        ...
        draw_community(G, comm_lp, 'results/community_c_lp_d')
    print(comm_lp_val)
    ...
    if puh == 1.0:
        ...
        plt.savefig('results/degree_c_d.png')
        plt.clf()

    # parallel running
    directory = 'rescre/tmpd/'
    ...
    print(components)
    print("running time data collection", (time.time() - start_time_i)/60) #r
